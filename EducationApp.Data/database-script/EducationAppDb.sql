IF NOT EXISTS (SELECT 1 FROM sys.databases WHERE name = 'EducationAppDB')
BEGIN
    -- Create the database
    CREATE DATABASE EducationAppDB;
END
ELSE
BEGIN
   DROP DATABASE EducationAppDB;
END
